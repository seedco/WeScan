Pod::Spec.new do |spec|
  spec.name             = 'Seed-WeScan'
  spec.version          = '1.5.0-seed.0'
  ...
  spec.homepage         = 'https://github.com/seedco/WeScan'
  spec.license          = { :type => 'MIT', :file => 'LICENSE' }
  spec.authors           = {
    'Boris Emorine' => 'boris@wetransfer.com',
    'Antoine van der Lee' => 'antoine@wetransfer.com'
  }
  spec.source           = { :git => 'https://github.com/seedco/WeScan.git', :tag => "#{spec.version}" }
