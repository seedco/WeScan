...
public final class ImageScannerController: UINavigationController {
    ...
    public required init(image: UIImage? = nil, delegate: ImageScannerControllerDelegate? = nil) {
        ...
        startNewScan(image: image, animated: false)
    }
    ...
    public func startNewScan(image: UIImage? = nil, animated: Bool = false) {
            ...
            var detectedQuad: Quadrilateral?
             ...
             if #available(iOS 11.0, *) {
                 ...
                 VisionRectangleDetector.rectangle(forImage: ciImage, orientation: orientation) { (quad) in
                     ...
                     self.setViewControllers([editViewController], animated: animated)
                 }
             } else {
                 ...
                 let editViewController = EditScanViewController(image: image, quad: detectedQuad, rotateImage: false)
                 setViewControllers([editViewController], animated: animated)
             }
        } else {
            setViewControllers([ScannerViewController()], animated: animated)
        }
    }
